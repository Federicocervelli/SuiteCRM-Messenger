...
import asyncio
import util.sms
from util.mail import invia_mail
import logging
...
def sendMsg(msg):
    if msg['name_value_list']['notification_type']['value'] == 'EMAIL':
        return invia_mail(mittente, 'federicocervelli01@gmail.com', msg['name_value_list']['subject']['value'], msg['name_value_list']['body']['value'], password, msg['id'])
